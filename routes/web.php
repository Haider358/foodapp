...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => ['UserAuth']], function () {
        ...
        Route::get('edit-user/{id}', 'AdminController@edit_user')->name('edit-user');
        Route::get('active-inactive-user/{id}', 'AdminController@active_inactive_user')->name('active-inactive-user');
        Route::get('view-all-coache', 'AdminController@view_all_coache')->name('view-all-coache');
    });
});
